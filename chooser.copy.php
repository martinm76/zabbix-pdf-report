...
<p>
<input type="checkbox" name="graphs" value="Graphs" checked>Include graphs</input> &nbsp;
<input type="checkbox" name="triggers" value="Triggers">Show triggers and acknowledgements
</p>
</td><td valign="middle">
&nbsp;
</td></tr>
